...
#define pstr_alloc(len) debug_pstr_alloc(len, __FILE__, __LINE__)
#define pstr_cstr(cstr) debug_pstr_cstr(cstr, __FILE__, __LINE__)
#define pstr_cstr_size(cstr, size) debug_pstr_cstr_size(cstr, size, __FILE__, __LINE__)
#define pstr_copy(str) debug_pstr_copy(str, __FILE__, __LINE__, #str)
#define pstr_free(str) debug_pstr_free(str, __FILE__, __LINE__, #str)
#endif
#endif
